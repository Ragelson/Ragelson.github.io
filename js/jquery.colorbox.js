...
-------------------------------------*/
			$(document).ready(function(){
				...
				$(".group01").colorbox({rel:'group01', transition:"fade"});
				$(".group02").colorbox({rel:'group02', transition:"fade"});
				$(".group03").colorbox({rel:'group03', transition:"fade"});
				$(".group04").colorbox({rel:'group04', transition:"fade"});
				$(".group05").colorbox({rel:'group05', transition:"fade"});
				$(".group06").colorbox({rel:'group06', transition:"fade"});
				$(".group07").colorbox({rel:'group07', transition:"fade"});
				$(".group08").colorbox({rel:'group08', transition:"fade"});
				$(".group09").colorbox({rel:'group09', transition:"fade"});
				...
				$(".group38").colorbox({rel:'group38', transition:"fade"});
				$(".group39").colorbox({rel:'group39', transition:"fade"});
				$(".group40").colorbox({rel:'group40', transition:"fade"});
				$(".group41").colorbox({rel:'group41', transition:"fade"});
				$(".group42").colorbox({rel:'group42', transition:"fade"});
				$(".group43").colorbox({rel:'group43', transition:"fade"});
				$(".group44").colorbox({rel:'group44', transition:"fade"});
				$(".googlemap").colorbox({iframe:true,width:844,height:600});
				$(".kou").colorbox({rel:'kou', transition:"fade"});
				$(".bou").colorbox({rel:'bou', transition:"fade"});
				$(".yu").colorbox({rel:'yu', transition:"fade"});
				$(".on").colorbox({rel:'on', transition:"fade"});
				$(".jin").colorbox({rel:'jin', transition:"fade"});
				$(".kon").colorbox({rel:'kon', transition:"fade"});
				$(".ku").colorbox({rel:'ku', transition:"fade"});
				$(".to").colorbox({rel:'to', transition:"fade"});
				$(".ken").colorbox({rel:'ken', transition:"fade"});
				$(".kai").colorbox({rel:'kai', transition:"fade"});
				$(".ajax").colorbox();
				$(".youtube").colorbox({iframe:true, innerWidth:853, innerHeight:480});
				$(".tgs2014").colorbox({iframe:true, innerWidth:611, innerHeight:751});
				$(".vimeo").colorbox({iframe:true, innerWidth:500, innerHeight:409});
				$(".iframe").colorbox({iframe:true, width:"853px", height:"530px"});
